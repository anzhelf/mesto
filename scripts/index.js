...
function togglePopup() {//открыть закрыть попап
...
function handleFormSubmit(evt) {//отправить форму
...
saveButton.addEventListener("click", handleFormSubmit);// сохраняем и обновляем инфу
